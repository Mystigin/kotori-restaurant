    ...
    div.innerHTML = [
      '<div class="book-mount" id="menu">',
        ...
        '<div class="book-stage" data-state="0">',
          ...
          '<div class="page-flip page-flip-right" aria-hidden="true">',
            '<img class="menu-flat" data-menu="menu-2" src="images/menu-2.png" alt="">',
          '</div>',
          '<div class="page-flip page-flip-left" aria-hidden="true">',
            '<img class="menu-flat" data-menu="menu-3" src="images/menu-3.png" alt="">',
          '</div>',
          '<div class="book">',
